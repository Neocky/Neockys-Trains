	...
	data:extend({
		{
			...
			icon = "__Neocky's-Trains__/graphics/technology-train-battery.png",
			icon_size = 128,
			effects = 
			{
				{
	...
	data:extend({
		{
			...
			icon = "__Neocky's-Trains__/graphics/technology-train-fusion.png",
			icon_size = 128,
			effects = 
			{
				{
	...
	data:extend({
		{
			...
			icon = "__Neocky's-Trains__/graphics/technology-train-uranium.png",
			icon_size = 128,
			effects = 
			{
				{
